...
NUM_STEPS = 7 # Number of images in the validation set.
OUTPUT_DIR = './output/only-parsing/example'

# for validation sest use this dirs !!!
# DATA_DIRECTORY = './datasets/lip/LIP_dataset/valid_set/images/'
# DATA_LIST_PATH = '/media/sda1/JJug/mag/LIP_JPPNet/datasets/lip/val_id_jpg.txt'
# NUM_STEPS = 10000 # Number of images in the validation set.
# OUTPUT_DIR = './output/parsing/val'

RESTORE_FROM = './checkpoint/julijan-seg'
...
def main():
    ...
    with tf.variable_scope('', reuse=False):
        ...
        parsing_out2_100, parsing_fea2_100 = parsing_refine_no_pose(parsing_out1_100, parsing_fea1_100, name='fc2_parsing')
        parsing_out3_100, parsing_fea3_100 = parsing_refine_no_pose(parsing_out2_100, parsing_fea2_100, name='fc3_parsing')
    ...
    with tf.variable_scope('', reuse=True):
        ...
        parsing_out2_075, parsing_fea2_075 = parsing_refine_no_pose(parsing_out1_075, parsing_fea1_075, name='fc2_parsing')
        parsing_out3_075, parsing_fea3_075 = parsing_refine_no_pose(parsing_out2_075, parsing_fea2_075, name='fc3_parsing')
    ...
    with tf.variable_scope('', reuse=True):
        ...
        parsing_out2_125, parsing_fea2_125 = parsing_refine_no_pose(parsing_out1_125, parsing_fea1_125, name='fc2_parsing')
        parsing_out3_125, parsing_fea3_125 = parsing_refine_no_pose(parsing_out2_125, parsing_fea2_125, name='fc3_parsing')
    ...
    # da vrnemo vmesno sliko namesto koncne odstrani parsing_out2 in 3iz spodnjega raw outputa
