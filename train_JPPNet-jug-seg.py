...
#this model trains using only segmentation
...
### parameters setting
N_CLASSES = 20
#  I reduced the image size for faster processing
# INPUT_SIZE = (384, 384)
INPUT_SIZE = (64, 64)
BATCH_SIZE = 1
BATCH_I = 1
...
SNAPSHOT_DIR = './checkpoint/julijan-seg'
LOG_DIR = './logs/julijan-seg'
...
def main():
        ...
        with tf.device('/gpu:%d' % i):
            with tf.name_scope('Tower_%d' % (i)) as scope:
                ...
                with tf.variable_scope('', reuse=reuse2):
                    ...
                    parsing_out2_050, parsing_fea2_050 = parsing_refine_no_pose(parsing_out1_050, parsing_fea1_050, name='fc2_parsing')
                    parsing_out3_050, parsing_fea3_050 = parsing_refine_no_pose(parsing_out2_050, parsing_fea2_050, name='fc3_parsing')
    ...
    loss_summary = tf.summary.merge([loss_summary_ave, loss_summary_p1, loss_summary_p2, loss_summary_p3])
